    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark mainColour"  data-bs-theme="light" >
      ...
      <div class="collapse navbar-collapse" id="navbarone">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active fontMain">
            <router-link to="/About" class="nav-link active fontMain">About</router-link>
          </li>
          <li class="nav-item dropdown fontMain">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li>
                <router-link to="/OwnerAccount" class="dropdown-item fontMainDropdown">Profile</router-link>
              </li>
              <li>
                <router-link to="/OwnerLogin" class="dropdown-item fontMainDropdown">Log In</router-link>
              </li>
              <li>
                <router-link to="/OwnerSignUp" class="dropdown-item fontMainDropdown">Sign Up</router-link>
              </li>
            </ul>
          </li>
          <li class="nav-item dropdown fontMain">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li>
                <router-link to="/StudentAccount" class="dropdown-item fontMainDropdown">Profile</router-link>
              </li>
              <li>
